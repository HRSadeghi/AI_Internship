...
از این [https://www.section.io/engineering-education/dropout-regularization-to-handle-overfitting-in-deep-learning-models/](لینک) میتوانید برای کمک بیشتر استفاده بگیرید.

۲. در این مرحله میخواهیم از transfer learning استفاده کنیم. 

دیتاست (https://pytorch.org/vision/stable/generated/torchvision.datasets.FashionMNIST.html)[fashion-Mnist] را دانلود کنید یا از طریق خود pytorch به آنه دسترسی پیدا کنید. حالا به روش های زیر مدل را آموزش دهید:
