...
### لایه های Normalization
در لایه Normalization ما با استفاده از محدود کردن یا کنترل مقدار feature خروجی از هر لایه، می توانیم سرعت آموزش مدل را افزایش دهیم. با مراجعه به [این لینک](https://towardsdatascience.com/different-normalization-layers-in-deep-learning-1a7214ff71d6) با روش های normalization بیشتر آشنا شوید.



### دیتا Normalization
دیتا Normalization روشی است جهت preprocess داده که به پایداری عددی مدل و در برخی موارد کاهش زمان آموزش منجر میشود. در [این لینک](https://towardsdatascience.com/understand-data-normalization-in-machine-learning-8ff3062101f0)
با این روش بیشتر آشنا می شوید.



### لایه های pooling 
شبکه های کانولوشنی بر روی تصاویر عملکرد بالایی را از خود نشان داده اند و می توانند ویژگی های موجود در تصویر را به خوبی استخراج کنند. یکی ازمشکلات این دسته از شبکه ها، این است که به مکان خاص هر ویژگی در تصویر حساس هستند و با جابجایی اندک تصویر ویژگی های خروجی تغییر میکنند. یک راه حل برای این مشکل down-sample کردن تصویر است. این down-sample کردن می تواند با افزایش stride در لایه های کانولوشنی یا افزودن لایه ی pooling انجام شود. برای آشنایی بیشتر با انواع لایه ی pooling به [این لینک](https://machinelearningmastery.com/pooling-layers-for-convolutional-neural-networks/) مراجعه کنید.



### transfer learning
در خیلی از موارد ما برای آموزش مدل روی یک مسئله خاص به دیتا زیادی دسترسی نداریم و نمی توانیم مدل را به خوبی روی این دیتا آموزش بدهیم. برای همین مدل را روی مسئله دبگری که دیتا زیادی برای آن  در دسترس است آموزش می دهیم و سپس از مدل آموزش داده شده برای آموزش مدل روی مسئله خاص خود استفاده می کنیم. به این روش transfer learning گفته می شود.
 در [این لینک](https://machinelearningmastery.com/transfer-learning-for-deep-learning/) با  transfer learning بیشتر آشنا می شویم.
همچنین برای یادگیری نحوه استفاده از مدل های آموزش داده شده در پایتورچ [این لینک](https://pytorch.org/tutorials/beginner/transfer_learning_tutorial.html) را مطالعه کنید.
