...
به ازای هر داده جدید چون $x$ ابتدا میانگین $X$ را از آن کم می‌کنیم و سپس با ماتریس تبدیل $T$ به فضای جدید منتقل می‌کنیم و ویژگی‌های متناظر را در فضای جدید به دست می‌آوریم.:
