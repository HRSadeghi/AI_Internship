...
که در این رابطه ماتریس $U$ و $V$ ماتریس‌های متعامد هستند و ماتریس $\Sigma$ یک ماتریس قطری است. توجه کنید که ماتریس متعامد ماتریسی است که ضرب آن در تنهاده‌اش (از سمت راست، چپ یا هر دو طرف) برابر ماتریس همانی شود.
